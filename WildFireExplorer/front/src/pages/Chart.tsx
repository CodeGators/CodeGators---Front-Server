...
import { Sort } from "../services/quick_sort"; // Importação atualizada
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        // Usando quickSort em vez de bubbleSort
        setStateData(sorterEstados.quickSort(estados, "count"));
        setBiomeData(sorterBiomas.quickSort(biomas, "count"));
      } catch (error) {
