...
// import { AreaQueryParams, AreaFeatureCollection } from '../../types/geojson';
...
interface AreaGeoJSONFeature { // Mantenha se não importado de types/geojson.ts
  type: 'Feature';
  geometry: any;
  properties: any;
}
interface AreaFeatureCollection { // Mantenha se não importado de types/geojson.ts
